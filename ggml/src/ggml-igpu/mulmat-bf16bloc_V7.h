...
#               pragma unrool KV
    ...
    )
    {
        ...
        constexpr auto ML = t::ML;
        constexpr auto NL = t::NL;
        ...
        const hipint_t tid = LOAD_A?tid_:(tid_-(NB_THREAD/2));
        ...
        // les shareds:
        using A_frag_in_t   = a_load_t[K1][M2][M1][K0][t::ML];
        using A_frag_out_t  = a_vect_t[K1][M2][M1][K0][M0];
        using B_frag_in_t   = b_load_t[K1][N2][N1][K0][t::NL];
        ...
        A_frag_in_t*  A_frag_in  = reinterpret_cast<A_frag_in_t*>  (&data[0]);
        A_frag_out_t* A_frag_out = reinterpret_cast<A_frag_out_t*> (&data[0]);

        B_frag_in_t*  B_frag_in  = reinterpret_cast<B_frag_in_t*>  (&data[sizeof(A_frag_in_t)*2]);
        B_frag_out_t* B_frag_out = reinterpret_cast<B_frag_out_t*> (&data[sizeof(A_frag_in_t)*2]);
