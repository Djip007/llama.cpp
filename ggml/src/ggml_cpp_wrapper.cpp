...
namespace ggml::cpp::backend {
    ...
    //=========================================================
    // les wrappper pour ggml_backend_buffer_type
    ...
    std::size_t buffer_type_get_alloc_size(ggml_backend_buffer_type_t buft, const ggml_tensor * tensor) {
        auto& ctx = *((ggml::cpp::backend::buffer_type*) (buft->context));
        // voir si on ne ferais pas une classe pour ca.
    ...
    //=========================================================
    // les wrappper pour ggml_backend
    ...
    //=========================================================
    // les wrappper pour ggml_backend_device
    ...
    //=========================================================
    // les wrappper pour ggml_backend_reg
    ...
    void *             reg_get_proc_address(ggml_backend_reg_t reg, const char * name) {
        auto& ctx = *((ggml::cpp::backend::reg*) (reg->context));
        return ctx.get_proc_address(name);
    }
