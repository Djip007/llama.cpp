...
namespace ggml::cpp::backend {
    ...
    public:
        ...
        virtual const std::string& get_name() = 0;
        virtual ggml_guid_t get_guid() = 0;

        // => device::caps_async() {return true;}
        ...
        // => device::caps_events() { return true; }
    ...
    public:
        ...
        virtual bool caps_host_buffer()          { return false; }
    ...
    public:
        ...
        virtual void *            get_proc_address(const std::string& /*name*/) { return nullptr; }
    };
    ...
    ggml_backend_dev_t         c_wrapper(ggml_backend_reg_t, device* ctx);
