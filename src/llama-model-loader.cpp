...
static std::string llama_model_ftype_name(llama_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_FQ8_4:    return "FQ8_4";
        case LLAMA_FTYPE_MOSTLY_FQ8_3:    return "FQ8_3";
...
llama_model_loader::llama_model_loader(
    ...
    // TODO: make optional
    {
        ...
        switch (type_max) {
            ...
            case GGML_TYPE_FQ8_4:   ftype = LLAMA_FTYPE_MOSTLY_FQ8_4;   break;
            case GGML_TYPE_FQ8_3:   ftype = LLAMA_FTYPE_MOSTLY_FQ8_3;   break;
            default:
                {
