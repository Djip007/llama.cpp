...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_E4M3_Q        = 38, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_E3M4_Q        = 39, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_FQ8_4         = 40, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_FQ8_3         = 41, // except 1d tensors
